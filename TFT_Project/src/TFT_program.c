...
{
    MGPIO_voidSetPinMode(HTFT_A0_PORT_PIN, GPIO_OUTPUT_MODE); // PA0 A0
   // MGPIO_voidSetPinMode(HTFT_CS_PORT_PIN, GPIO_OUTPUT_MODE); // PA1 CS
    MGPIO_voidSetPinMode(HTFT_RST_PORT_PIN, GPIO_OUTPUT_MODE); // PA1 CS
	
    MGPIO_voidSetPinOutputSpeed(HTFT_A0_PORT_PIN, GPIO_OUTPUT_LOW_SPEED);
	//MGPIO_voidSetPinOutputSpeed(HTFT_CS_PORT_PIN, GPIO_OUTPUT_LOW_SPEED);
	MGPIO_voidSetPinOutputSpeed(HTFT_RST_PORT_PIN, GPIO_OUTPUT_LOW_SPEED);
